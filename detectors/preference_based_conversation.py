"""
detectors/preference_based_conversation.py
------------------------------------------
Builds the few-shot Conversation for detecting
Preference-Data Collection (Pairwise Comparison) data collection in RL code.

Prompt files (all under prompts/preference_based/):
...
_PROMPT_DIR = _PROJECT_ROOT / "prompts" / "preference_based"
...
def _read(filename: str) -> str:
    ...
    if not path.exists():
        raise FileNotFoundError(
            ...
            f"Expected files:\n"
            f"  prompts/preference_based/system.txt\n"
            f"  prompts/preference_based/question.txt\n"
            f"  prompts/preference_based/sample_context.txt\n"
            f"  prompts/preference_based/sample_answer.txt"
        )
...
def create_python_rl_preference_based_conversation(
    target_context: str,
) -> Conversation:
    """
    Build a few-shot Conversation for the LLM to detect
    Preference-Data Collection (Pairwise Comparison) data collection patterns.
