...
_PROMPT_DIR = _PROJECT_ROOT / "prompts" / "league_based"
...
def _read(filename: str) -> str:
    ...
    if not path.exists():
        raise FileNotFoundError(
            ...
            f"Expected files:\n"
            f"  prompts/league_based/system.txt\n"
            f"  prompts/league_based/question.txt\n"
            f"  prompts/league_based/sample_context.txt\n"
            f"  prompts/league_based/sample_answer.txt"
        )
